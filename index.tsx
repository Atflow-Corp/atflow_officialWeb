                            ...
                            <div className="modal-header-info">
                                ...
                                >
                                    {selectedProduct.id === 'purple-whale' && (
                                        <img src={`${import.meta.env.BASE_URL}img/pw_icon.png`} alt="Purple Whale icon" className="product-icon-image" />
                                    )}
                                    {selectedProduct.id === 'research-flow' && (
                                        <img src={`${import.meta.env.BASE_URL}img/RF_logo.png`} alt="Research Flow logo" className="product-icon-image" />
                                    )}
                                        ...
                                        {CAREER_DATA.map((job, idx) => (
                                            <div key={idx} className="career-item" onClick={() => window.open('https://airtable.com/appHfkk8lRDCVOosh/pag2uMlTkFfuRKEJV/form', '_blank')}>
                                                <div className="role-info">
                                                    <h4>{job.role}</h4>
                                                    {(job as any).type && <p>{(job as any).type} • {(job as any).location}</p>}
                                                </div>
